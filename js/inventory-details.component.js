System.register(['angular2/core', 'angular2/router', './inventory/inventory-filter.pipe'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, inventory_filter_pipe_1, router_2;
        ...
        execute: function() {
            InventoryDetailsComponent = (function () {
                ...
                InventoryDetailsComponent = __decorate([
                    core_1.Component({
                        templateUrl: 'app/item-information.component.html',
